...
inline mla_bool_t mla_http_server_request_test_handler(mla_http_server_t& http_server, const mla_user_data_t &userdata, const mla_http_request_t &request, mla_http_response_t &response) {
    ...
    response.content = mla_stream_input_from_buffer(mla_r_cast<mla_byte_t *>(mla_c_cast<mla_char_t*>(body)), sizeof(mla_char_t) * 4);
...
inline void HttpServerMultiHandlerTest() {
    ...
    if (mla_http_server_start(server, 2)) {
        ...
        response1.response.content.read(response1.response.content, 0, 4, mla_r_cast<mla_byte_t *>(body_buffer));
        ...
        request2.content = mla_stream_input_from_buffer(mla_r_cast<mla_byte_t *>(mla_c_cast<mla_char_t*>("hello world")), 12);
        ...
        response2.response.content.read(response2.response.content, 0, 12, mla_r_cast<mla_byte_t *>(body_2_buffer));
