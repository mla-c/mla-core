...
inline void MultiConfigDifferentOrderTest() {
    ...
    mla_array_list_add(config3.values, mla_s_cast<mla_int32_t>(1));
    mla_array_list_add(config3.values, mla_s_cast<mla_int32_t>(2));
    mla_array_list_add(config3.values, mla_s_cast<mla_int32_t>(3));
