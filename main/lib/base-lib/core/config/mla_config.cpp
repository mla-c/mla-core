...
mla_bool_t mla_private_mla_config_disabled_commit_output(mla_bytes_t output, mla_size_t unused_bytes) {
    (void)unused_bytes;
    mla_bytes_destroy(output);
    return false;
}

mla_bool_t mla_private_mla_config_disabled_reset() {
    return false;
}
...
static mla_config_low_level_operations_t g_low_level_operations = {
    mla_bytes_empty,
    mla_bytes_empty,
    mla_private_mla_config_disabled_commit_output,
    mla_private_mla_config_disabled_reset
};
