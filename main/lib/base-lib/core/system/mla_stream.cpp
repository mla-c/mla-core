...
struct mla_private_stream_buffer_manager {
    ...
    static mla_private_stream_buffer_manager init() {
        return {
            nullptr,
                0,
                0
...
mla_size_t mla_private_stream_noop_write(mla_stream_output_t& output, mla_size_t offset, mla_size_t length, const mla_byte_t* buffer) {
    (void) output;
    (void) offset;
    (void) buffer;
    return length;
...
mla_size_t mla_private_stream_noop_read(mla_stream_input_t& input, mla_size_t offset, mla_size_t length, mla_byte_t* buffer) {
    (void) input;
    (void) offset;
    (void) buffer;
    (void) length;
...
mla_size_t mla_private_stream_input_read_from_buffer(mla_stream_input_t& input, mla_size_t offset, mla_size_t length, mla_byte_t* buffer) {

    mla_private_stream_buffer_manager* manager = mla_user_data_get_pointer_data<mla_private_stream_buffer_manager>(input.userdata, mla_stream_buffer_manager_userdata_name);
...
mla_size_t mla_private_stream_input_buffer_remaining_bytes(mla_stream_input_t& input) {
...
mla_stream_input_t mla_stream_input_from_buffer(mla_byte_t* buffer, mla_size_t size) {
    ...
    mla_pointer_t bufferManager_ptr = mla_malloc_struct(mla_private_stream_buffer_manager);

    mla_private_stream_buffer_manager* bufferManager = mla_pointer_get_data<mla_private_stream_buffer_manager>(bufferManager_ptr);
    ...
    return {
        user_data,
        mla_private_stream_input_read_from_buffer,
        mla_private_stream_input_buffer_remaining_bytes
    };
}

mla_size_t mla_private_stream_output_write_to_buffer(mla_stream_output_t& output, mla_size_t offset, mla_size_t length, const mla_byte_t* buffer) {

    mla_private_stream_buffer_manager* manager = mla_user_data_get_pointer_data<mla_private_stream_buffer_manager>(output.userdata, mla_stream_buffer_manager_userdata_name);
...
mla_size_t mla_private_stream_output_buffer_available_bytes(mla_stream_output_t& output) {
...
mla_stream_output_t mla_stream_output_to_buffer(mla_byte_t* buffer, mla_size_t size) {
    ...
    return {
        user_data,
        mla_private_stream_output_write_to_buffer,
        mla_private_stream_output_buffer_available_bytes
    };
}

mla_stream_input_t mla_stream_input_from_buffer(mla_size_t size) {

    mla_pointer_t bufferManager_ptr = mla_malloc_buffer(sizeof(mla_private_stream_buffer_manager) + size);
    mla_private_stream_buffer_manager* bufferManager = mla_pointer_get_data<mla_private_stream_buffer_manager>(bufferManager_ptr);
...
mla_size_t mla_private_stream_std_input_read(mla_stream_input_t& input, mla_size_t offset, mla_size_t length, mla_byte_t* buffer) {
...
mla_stream_input_t mla_stream_input_stdin() {
    ...
    return {
        mla_user_data_empty(),
        mla_private_stream_std_input_read,
        nullptr
    };

}

mla_size_t mla_private_stream_std_output_write(mla_stream_output_t& output, mla_size_t offset, mla_size_t length, const mla_byte_t* buffer) {
...
mla_stream_output_t mla_stream_output_stdout() {
    ...
    return {
        mla_user_data_empty(),
        mla_private_stream_std_output_write,
        nullptr
    };
...
mla_size_t mla_private_memory_stream_input_read(mla_stream_input_t& input, mla_size_t offset, mla_size_t length, mla_byte_t* buffer) {
...
mla_size_t mla_private_memory_stream_input_remaining_bytes(mla_stream_input_t& input) {
...
mla_size_t mla_private_memory_stream_output_write(mla_stream_output_t& output, mla_size_t offset, mla_size_t length, const mla_byte_t* buffer) {
...
mla_size_t mla_private_memory_stream_output_available_bytes(mla_stream_output_t& output) {
...
mla_memory_stream_t mla_memory_stream(mla_size_t initial_size, mla_bool_t can_grow) {
    ...
    return {
        {
            user_data,
            mla_private_memory_stream_input_read,
            mla_private_memory_stream_input_remaining_bytes,
        },
        {
            user_data,
            mla_private_memory_stream_output_write,
            mla_private_memory_stream_output_available_bytes,
        }
    };
}
...
mla_size_t mla_private_stream_output_size_calculation_write(mla_stream_output_t& output, mla_size_t offset, mla_size_t length, const mla_byte_t* buffer) {
    (void)output;
    (void)buffer;
    (void)offset;
...
mla_stream_output_t mla_stream_output_size_calculation() {
    ...
    return {
        data,
        mla_private_stream_output_size_calculation_write,
        nullptr
    };
