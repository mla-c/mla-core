...
#define mla_log_msg(level, msg) mla_private_logging_native(level, msg)
#define mla_verbose(msg) mla_private_logging_native(MLA_LOG_LEVEL_VERBOSE, msg)
#define mla_debug(msg) mla_private_logging_native(MLA_LOG_LEVEL_DEBUG, msg)
#define mla_info(msg) mla_private_logging_native(MLA_LOG_LEVEL_INFO, msg)
#define mla_warning(msg) mla_private_logging_native(MLA_LOG_LEVEL_WARNING, msg)
#define mla_error(msg) mla_private_logging_native(MLA_LOG_LEVEL_ERROR, msg)
