...
void mla_private_mla_global_network_wifi_esp32_init() {
...
mla_lifecycle_boot_event_static_register(mla_lifecycle_boot_event_priority_network_postSetup, mla_private_mla_global_network_wifi_esp32_init)
