...
#ifndef MLA_GLOBAL_CONFIG_RASPBERRY_PICO_H
#define MLA_GLOBAL_CONFIG_RASPBERRY_PICO_H
...
mla_bytes_t mla_private_pico_inmemory_read_config_input() {
...
mla_bytes_t mla_private_pico_inmemory_create_config_output_buffer() {

    return mla_bytes(mla_max_config_size);
}

mla_bool_t mla_private_pico_inmemory_commit_config_output(mla_bytes_t& output, mla_size_t unused_bytes) {
...
mla_bool_t mla_private_pico_inmemory_config_reset() {
...
mla_config_low_level_operations_t g_config_low_level_operations = {
    mla_private_pico_inmemory_read_config_input,
    mla_private_pico_inmemory_create_config_output_buffer,
    mla_private_pico_inmemory_commit_config_output,
    mla_private_pico_inmemory_config_reset
};
