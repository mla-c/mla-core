...
void PointerNoopMemoryManagementBenchmark() {
...
void RegisterPointerBenchmarks(mla_benchmark_executor_t &p_BenchmarkExecutor) {
    ...
    benchmark = mla_benchmark("PointerNoopMemory", benchmark_category, PointerNoopMemoryManagementBenchmark);
    mla_benchmark_executor_register(p_BenchmarkExecutor, benchmark);
