---
applyTo: '**'
description: 'Patterns for adding reflection metadata and using serialization in the MLA framework'
---

# Reflection and Serialization

The reflection module (`core-os/reflection/mla_reflection.h`) provides **runtime type metadata** for structs. The serializer module (`core-os/serializer/mla_serializer.h`) uses this metadata to serialize and deserialize structured data to JSON, binary, or XML formats.
