...
### mla-c (`framework/core/`)

The main library providing fundamental operating system abstractions and utilities. [Documentation](framework/core/readme.md)

#### **System** (`system/`) - [Documentation](framework/core/system/readme.md)
...
#### **Task Management** (`task/`) - [Documentation](framework/core/task/readme.md)
...
- **HTTP Client** - `mla_http_client.h` - HTTP/HTTPS client implementation - [HTTP Documentation](framework/core/http/readme.md)
- **HTTP Server** - `mla_http_server.h` - Lightweight HTTP server - [HTTP Documentation](framework/core/http/readme.md)
- **HTTP Headers** - `mla_http_header.h` - Header parsing and management - [HTTP Documentation](framework/core/http/readme.md)
- **Network** - `mla_network.h` - Socket abstractions - [Network Documentation](framework/core/network/readme.md)
- **URL Parser** - `mla_url.h` - URL parsing and manipulation - [URL Documentation](framework/core/url/readme.md)

#### **Remote Procedure Call (RPC)** (`rpc/`) - [Documentation](framework/core/rpc/readme.md)
...
#### **Lifecycle Management** (`lifecycle/`) - [Documentation](framework/core/lifecycle/readme.md)
...
#### **Serialization** (`serializer/`) - [Documentation](framework/core/serializer/readme.md)
...
#### **Logging** (`log/`) - [Documentation](framework/core/log/readme.md)
...
#### **Command Line Interface** (`cli/`) - [Documentation](framework/core/cli/readme.md)
...
#### **Configuration** (`config/`) - [Documentation](framework/core/config/readme.md)
...
#### **File System** (`filesystem/`) - [Documentation](framework/core/filesystem/readme.md)
- **File System** - `mla_file_system.h` - File and directory operations

#### **Memory Management** (`memory/`) - [Documentation](framework/core/memory/readme.md)
- **Memory Hook** - `mla_memory_hook.h` - Custom memory allocator integration

#### **Utilities** (`utils/`, `hash/`)
- **Character Utils** - `mla_char_utils.h` - Character manipulation functions - [Utils Documentation](framework/core/utils/readme.md)
- **Endian Utils** - `mla_endian_utils.h` - Handling byte order - [Utils Documentation](framework/core/utils/readme.md)
- **Hash Functions** - `mla_hash.h` - Hashing algorithms - [Hash Documentation](framework/core/hash/readme.md)

#### **User Interface** (`ui/`) - [Documentation](framework/core/ui/readme.md)
...
#### **Reflection** (`reflection/`) - [Documentation](framework/core/reflection/readme.md)
...
### Platform Abstractions (`framework/core-platform/`)

Platform-specific implementations providing native functionality:

- **Generic** - Portable implementations for all platforms - [Documentation](framework/core-platform/generic/readme.md)
- **Windows** - Windows API integration - [Documentation](framework/core-platform/windows/readme.md)
- **Linux** - POSIX-compliant implementations - [Documentation](framework/core-platform/linux/readme.md)
- **WASM** - WebAssembly browser/Node.js runtime - [Documentation](framework/core-platform/wasm/readme.md)
- **Raspberry Pi** - ARM-specific optimizations - [Documentation](framework/core-platform/raspberry/readme.md)
- **ESP-IDF** - ESP32/ESP8266 embedded support - [Documentation](framework/core-platform/espidf/readme.md)
...
### Test Support Library (`framework/core-test-support/`) - [Documentation](framework/core-test-support/readme.md)
...
Use types from `framework/core/mla_data_types.h` in APIs and module code (`mla_int32_t`, `mla_size_t`, `mla_bool_t`, `mla_char_t`, ...).
...
- Keep platform-specific implementation in `framework/core-platform/*` so shared module APIs remain cross-platform.
...
For module-level guidance, see [framework/core/readme.md](framework/core/readme.md) and [framework/core/memory/readme.md](framework/core/memory/readme.md).
