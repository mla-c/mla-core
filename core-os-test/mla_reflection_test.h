...
#ifndef COREOS_MLA_REFLECTION_TEST_H
#define COREOS_MLA_REFLECTION_TEST_H
...
struct test_simple_struct_t {
    ...
    static mla_reflection_struct_metadata_t metadata() {
        mla_reflection_struct_metadata_t meta = mla_reflection_struct_metadata(mla_string_const("test_simple_struct_t"), sizeof(test_simple_struct_t));
...
struct test_nested_struct_t {
    ...
    static mla_reflection_struct_metadata_t metadata() {
        mla_reflection_struct_metadata_t meta = mla_reflection_struct_metadata(mla_string_const("test_nested_struct_t"), sizeof(test_nested_struct_t));
...
struct test_list_struct_t {
    ...
    static mla_reflection_struct_metadata_t metadata() {
        mla_reflection_struct_metadata_t meta = mla_reflection_struct_metadata(mla_string_const("test_list_struct_t"), sizeof(test_list_struct_t));
...
inline void CreateStructMetadataTest() {
    mla_reflection_struct_metadata_t metadata = mla_reflection_struct_metadata(mla_string_const("TestStruct"), 128);
...
inline void AddFieldsToMetadataTest() {
    mla_reflection_struct_metadata_t metadata = mla_reflection_struct_metadata(mla_string_const("test_simple_struct_t"), sizeof(test_simple_struct_t));
...
inline void FreezeMetadataTest() {
    mla_reflection_struct_metadata_t metadata = mla_reflection_struct_metadata(mla_string_const("TestStruct"), 64);
...
inline void AllTypeFieldsTest() {
    ...
    mla_reflection_struct_metadata_t metadata = mla_reflection_struct_metadata(mla_string_const("all_types_t"), sizeof(all_types_t));
