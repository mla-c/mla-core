...
Tests are compiled and linked with the test support library and a platform-specific main entry point. See the [Test Support Library](../core-os-test-support/readme.md) for framework details and the build system for compilation instructions.
