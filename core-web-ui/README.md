...
C header: lib/base-lib/core/ui/web/mla_ui_web_embedded.h
        ↓ (compiled into mla-c)
...
The production build generates `lib/base-lib/core/ui/web/mla_ui_web_embedded.h`, which contains the entire web application as a gzip-compressed byte array. This header is included in the mla-c library and served by `mla_ui_http_server` when a client connects via browser.

For more information on the server-side integration, see the [UI Module Documentation](../lib/base-lib/core/ui/readme.md).
