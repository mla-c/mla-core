...
mla_bool_t mla_mla_deserializer_convert_to_int16(const mla_deserializer_token_t &token, mla_int16_t *out_value) {
    switch (token.type) {
        ...
        case MLA_DESERIALIZER_VALUE_UINT8:
            ...
            if (token.simple.uint8_value > mla_int16_max) {
                return false;
            }
...
mla_bool_t mla_mla_deserializer_convert_to_int32(const mla_deserializer_token_t &token, mla_int32_t *out_value) {
    switch (token.type) {
        ...
        case MLA_DESERIALIZER_VALUE_UINT8:
            ...
            if (token.simple.uint8_value > mla_int32_max) {
                return false;
            }
        ...
        case MLA_DESERIALIZER_VALUE_FLOAT:
            ...
            if (token.simple.float_value < mla_int32_min || token.simple.float_value > mla_int32_max) {
                return false;
            }
        ...
        case MLA_DESERIALIZER_VALUE_DOUBLE:
            ...
            if (token.simple.double_value < mla_int32_min || token.simple.double_value > mla_int32_max) {
                return false;
            }
    ...
    switch (token.type) {
        ...
        case MLA_DESERIALIZER_VALUE_UINT64:
            ...
            *out_value = (mla_int64_t) token.simple.uint64_value;
            return true;
        case MLA_DESERIALIZER_VALUE_FLOAT:
            if (token.simple.float_value < mla_int64_min || token.simple.float_value > mla_int64_max) {
                return false;
            }
            *out_value = (mla_int64_t) token.simple.float_value;
            return true;
        case MLA_DESERIALIZER_VALUE_DOUBLE:
            if (token.simple.double_value < mla_int64_min || token.simple.double_value > mla_int64_max) {
                return false;
            }
    ...
    switch (token.type) {
        ...
        case MLA_DESERIALIZER_VALUE_UINT64:
            ...
            *out_value = (mla_uint32_t) token.simple.uint64_value;
            return true;
        case MLA_DESERIALIZER_VALUE_FLOAT:
            if (token.simple.float_value < 0 || token.simple.float_value > mla_uint32_max) {
                return false;
            }
