...
#
#   include(path/to/framework/core/build/clang-tidy.cmake)
#   mla_enable_clang_tidy(<target>)
#
# The shared .clang-tidy configuration file lives next to this module and
# is passed explicitly to clang-tidy for every configured target.
#
...
if(MLA_ENABLE_CLANG_TIDY)
    set(MLA_CLANG_TIDY_CONFIG_FILE "${CMAKE_CURRENT_LIST_DIR}/.clang-tidy")

    if(NOT EXISTS "${MLA_CLANG_TIDY_CONFIG_FILE}")
        message(FATAL_ERROR "clang-tidy config not found: ${MLA_CLANG_TIDY_CONFIG_FILE}")
    endif()
...
function(mla_enable_clang_tidy target)
    ...
    set_target_properties(${target} PROPERTIES
        CXX_CLANG_TIDY "${MLA_CLANG_TIDY_EXE};--config-file=${MLA_CLANG_TIDY_CONFIG_FILE}"
    )
