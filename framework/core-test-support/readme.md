...
The `framework/core-test-support/` directory provides the testing and benchmarking infrastructure for mla-c. It includes a custom test framework, a benchmark framework, and platform-specific utilities for running tests across all supported platforms.
...
- **Default iterations**: 1,000,000 (customizable via `#define mla_test_global_config_benchmark_iterations`)
