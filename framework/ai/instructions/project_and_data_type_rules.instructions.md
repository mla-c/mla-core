...
- **Framework Config:** `framework/core/mla_global_config.h` (included via `mla_data_types.h`)
- **Test Config:** `framework/core-test-support/mla_test_global_config.h` (included via `mla_test_data_types.h`)
