...
The logging module (`framework/core/log/`) provides a structured, level-based logging system. Log messages are routed to one or more registered **loggers**, each with its own output destination and minimum log level.
