...
Place all module files under `framework/core/<module_name>/`:
...
```cpp
// framework/core/my_feature/mla_my_feature.h
...
```cpp
// framework/core/my_feature/mla_my_feature.cpp
...
Add the new `.cpp` file to the relevant source list in `framework/core/sources.cmake`:
...
Use the logging macros from `framework/core/log/mla_logging.h` to emit structured messages:
...
- [ ] Header file created under `framework/core/<module>/mla_<module>.h`
- [ ] Implementation file created under `framework/core/<module>/mla_<module>.cpp`
...
- [ ] `.cpp` added to `framework/core/sources.cmake`
