...
The CLI module (`framework/core/cli/`) provides a hierarchical command-line interface. Commands are grouped into **modules** (namespaces), each containing one or more **commands** with named parameters.
