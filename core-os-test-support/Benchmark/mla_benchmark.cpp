...
mla_test_pointer_t mla_benchmark_malloc_in_arena_hook(mla_test_uint32_t size) {
    ...
    mla_size_t aligned_offset = mla_align_up(g_mla_benchmark_memory_arena_offset, mla_global_config_benchmark_arena_alignment);
...
#if (mla_global_feature_flag_benchmark_use_median == 1)
...
void mla_benchmark_run_in_arena(mla_benchmark_t &benchmark, mla_test_uint32_t arena_size_per_run, mla_test_output_format_t output_format) {
...
#if (mla_global_config_benchmark_max_arena_size > 0)
    ...
    mla_test_uint64_t arena_size = mla_align_up(arena_size_per_run, mla_global_config_benchmark_arena_alignment) * benchmarkIterations;

    while (arena_size > mla_global_config_benchmark_max_arena_size) {
    ...
    arena_size = mla_align_up(arena_size, mla_global_config_benchmark_arena_alignment);
