...
#ifndef MLA_C_MLA_BENCHMARK_TIMER_STD_H
#define MLA_C_MLA_BENCHMARK_TIMER_STD_H
...
static double __tsc_ns_per_tick() {
...
static mla_test_uint64_t __current_nanoseconds_std() {
    static double ns_per_tick = __tsc_ns_per_tick();
