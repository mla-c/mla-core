...
```cpp
#include "base-lib/core-platform/wasm/mla_global_platform_wasm.h"
```
...
```cpp
#include "base-lib/core-platform/wasm/mla_global_platform_wasm_standalone.h"
```
...
```cpp
#include "base-lib/core-platform/wasm/mla_global_platform_task_manager_wasm.h"
```
